#!/bin/bash
# Debian Sid/Forky variant of librewolf-pywalfox-policy.sh.
# Arch install continues to use librewolf-pywalfox-policy.sh unchanged.
...
# Debian LibreWolf package layout (Forky/Sid).
DIST_POLICIES="/usr/share/librewolf/distribution/policies.json"
